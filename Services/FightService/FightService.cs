...
namespace dotnet_rpg.Services.FightService
{
    public class FightService : IFightService
    {
            ...
            try
            {
                ...
                while(!defeated)
                {
                    foreach(var attacker in Characters)
                    {
                        ...
                        bool useWeapon = new Random().Next(2) == 0;   // 2 inseamna ca rezultatul va fi 0 sau 1
                        ...
                        if(opponent.HitPoints <= 0)
                        {
                            ...
                            response.Data.Log.Add($"{attacker.Name} wins with {attacker.HitPoints}!");
                            break;
                        }
                    }
                }
        ...
        private static int DoSkillAttack(Character attacker, Character opponent, Skill Skill)
        {
            ...
            damage -= new Random().Next(opponent.Defeates);
        ...
        public async Task<ServiceResponse<List<HighscoreDto>>> GetHightscore()
        {
            var Characters = await _context.Characters
                .Where(c => c.Fights > 0)
